          ...
          if ($num_rows > 0)
          {
            ...
            $num_rows = $stmt->rowCount();
             ...
             echo "</table>";
              ...
              echo " <div class='center col s3'><form name='formpagefirst' id='formpagefirst' method='get' action='listennew.php'>
              ...
              echo " <div class='center col s3'><form name='formpageprevious' id='formpageprevious' method='get' action='listennew.php'>
              <button class='btn waves-effect waves-light $firstbuttonenabled' type='submit'>
              ...
              echo " <div class='center col s3'><form name='formpagenext' id='formpagenext' method='get' action='listennew.php'>
              ...
              echo " <div class='center col s3'><form name='formpagelast' id='formpagelast' method='post' action='listennew.php'>
              <button class='btn waves-effect waves-light $lastbuttonenabled' type='submit'>
